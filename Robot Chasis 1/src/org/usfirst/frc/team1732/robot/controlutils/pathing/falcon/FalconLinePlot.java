...
class FalconLinePlot extends JPanel implements ClipboardOwner {
	 ...
	 * 
	 * @param yData
	 *            is a array of doubles representing the Y-axis values of the data
	 *            to be plotted.
	 */
	...
	/**
	 * Constructor which Plots chart based on provided x and y data. X and Y arrays
	 * must be of the same length.
	 * 
	 * @param xData
	 *            is an array of doubles representing the X-axis values of the data
	 *            to be plotted.
	 * @param yData
	 *            is an array of double representing the Y-axis values of the data
	 *            to be plotted.
	 */
	 ...
	 * 
	 * @param data
	 *            is a 2D array of doubles of size Nx2 or 2xN. The plot assumes X is
	 *            the first dimension, and y data is the second dimension.
	 */
	 ...
	 * @param markerColor
	 *            is the color the user which to be used for the data point. Make
	 *            this null if the user wishes to not have datapoint markers.
	 */
	...
	/**
	 * Constructor which plots charts based on provided x and y axis data provided
	 * as separate arrays. The user can also specify the color of the adjoining
	 * line. Data markers are not displayed.
	 * 
	 * @param xData
	 *            is an array of doubles representing the X-axis values of the data
	 *            to be plotted.
	...
	/**
	 * Constructor which plots charts based on provided x and y axis data, provided
	 * as separate arrays. The user can also specify the color of the adjoining line
	 * and the color of the datapoint maker.
	 * 
	 * @param xData
	 *            is an array of doubles representing the X-axis values of the data
	 *            to be plotted.
