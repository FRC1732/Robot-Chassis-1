...
public class ReverseDrivetrainMovements extends Command {
	...
	protected void execute() {
		...
		drivetrain.setLeft(drivetrain.leftFFF.getAppliedVoltage(left.velocity, left.acceleration));
		drivetrain.setRight(drivetrain.rightFFF.getAppliedVoltage(right.velocity, right.acceleration));
	}
