...
public class SetArmScore extends CommandGroup {
	...
	public SetArmScore() {
		addSequential(new ArmPath(0.1, 0.5, ArmPositions.INTAKE, ArmPositions.HORIZONTAL, 0));
		addSequential(new ArmPath(0.5, 0.2, ArmPositions.HORIZONTAL, ArmPositions.UPRIGHT, 0));
