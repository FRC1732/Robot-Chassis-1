...
public class SetArmScore extends CommandGroup {
	...
	public SetArmScore() {
		...
		addSequential(new ArmPath(1, 0.5, ArmPositions.HORIZONTAL, ArmPositions.UPRIGHT, 0));
		addSequential(new ArmPath(0.4, -0.1, ArmPositions.UPRIGHT, ArmPositions.SCORE, 5));
	}
